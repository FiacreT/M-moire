...
sfOptdescs = {
    ...
    '_useragent': "User-Agent string to use for HTTP requests. Prefix with an arobase to randomly select the User Agent from a file containing user agent strings for each request,",
