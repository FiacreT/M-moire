...
def write_json(jsonfile, data, scan_info):
    ...
    #datadecode = [i.decode('UTF-8') for i in data]
    
    #json_data = json.dumps(datadecode, sort_keys=True, indent=4, separators=(',', ': '))
...
def main():
    ...
    print(isinstance(arguments.dictionary, str))
    arguments.dictionary = "hello"
    print(arguments.dictionary)
    exit()'''
    ...
    #print("xfr goo bing do_crt do_whois zonewalk spf_enum wildcard_filter proto type", xfr,goo,bing,do_crt,do_whois, zonewalk, spf_enum, wildcard_filter, proto, type)
    #print(type(type))
    #print(type(arguments.ns_server))
    ...
    if type is not None:
        ...
        usage()
        sys.exit(1)
    print("helloooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo")
