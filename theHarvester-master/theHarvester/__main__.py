...
class TheHarvester(Resource):
    #def post(self, target):
    
    def post(self, target, engine):
        try:
            ...
            if engine is not None:
                ...
                print("--------------------------------------------------------------------",engines)
                if engine == 'all' and args.exclude is not None:
                ...
                if set(engines).issubset(Core.get_supportedengines()):
                    ...
                    for engineitem in engines:
                        if engineitem == 'baidu':
                            ...
                            print('\033[94m[*] Searching Censys. \033[0m')
                            import theHarvester.discovery.censys as censys
                            search = censys.SearchCensys(word, limit)
                            search.process()
                            ...
                            print('\033[94m[*] Searching Cymon. \033[0m')
                            import theHarvester.discovery.cymon as cymon
                            # Import locally or won't work.
                            search = cymon.search_cymon(word)
                            search.process()
                            all_ip = search.get_ipaddresses()
                            ...
                            try:
                                print('\033[94m[*] Searching DNSdumpster. \033[0m')
                                import theHarvester.discovery.dnsdumpster as dnsdumpster
                                search = dnsdumpster.search_dnsdumpster(word)
                                search.process()
                                hosts = filter(search.get_hostnames())
                                all_hosts.extend(hosts)
                            ...
                            print('\033[94m[*] Searching DuckDuckGo. \033[0m')
                            import theHarvester.discovery.duckduckgosearch as duckduckgosearch
                            try:
                                search = duckduckgosearch.SearchDuckDuckGo(word, limit)
                                search.process()
                                emails = filter(search.get_emails())
                                ...
                                pass
                            print('\033[94m[*] Searching Hunter. \033[0m')
                            import theHarvester.discovery.huntersearch as huntersearch
                            # Import locally.
                            try:
                                search = huntersearch.SearchHunter(word, limit, start)
                                search.process()
                            ...
                            print('\033[94m[*] Searching Intelx. \033[0m')
                            import theHarvester.discovery.intelxsearch as intelxsearch
                            # Import locally or won't work.
                            try:
                                search = intelxsearch.SearchIntelx(word, limit)
                                search.process()
                            ...
                            print('\033[94m[*] Searching SecurityTrails. \033[0m')
                            import theHarvester.discovery.securitytrailssearch as securitytrailssearch
                            try:
                                search = securitytrailssearch.search_securitytrail(word)
                                search.process()
                                hosts = filter(search.get_hostnames())
                            ...
                            print('\033[94m[*] Searching Trello. \033[0m')
                            import theHarvester.discovery.trello as trello
                            # Import locally or won't work.
                            search = trello.search_trello(word, limit)
                            search.process()
                            emails = filter(search.get_emails())
            ...
            if filename != "":
                ...
                #sys.exit(0)
                return "ok", 201
            resultt= db.getlatestscanresults(word)
            print("-----------------------------------------------Result")
            print(all_emails)
            print(full)
            print(vhost)
            ...
            results.append(result)
            return result, 201
            #print("E R R O R - don't pass all argument")
            #pass
    
    def get(self, target, engine):
...
def entry_point():
    ...
    try:
        #start()
        api.add_resource(TheHarvester, "/theHarvester/<string:target>/<string:engine>")
